<?php
  ...
  $female = mysqli_query($con, "SELECT count(pwd_sex) as female from pwd_table where pwd_sex='Female'");
  $fetch_female = mysqli_fetch_assoc($female);

  $male = mysqli_query($con, "SELECT count(pwd_sex) as male from pwd_table where pwd_sex='Male'");
  $fetch_male = mysqli_fetch_assoc($male);

  $pwd_male = $fetch_male['male'];
  $pwd_female = $fetch_female['female'];
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Total Number of Person With Disability Categorize by Type</h3>
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse">
              <i class="fas fa-minus"></i>
              </button>
