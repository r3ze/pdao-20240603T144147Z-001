<?php
  ...
  if (isset($_GET['barangay-summary'])) {
  	$barangay = $_GET['barangay-summary'];
  }
...
<head>
	...
	<title><?php echo $barangay; ?> Summary Report</title>
	<!-- Favicon-->
	...
	<div class="row">
		...
		<table class="differentTable table">
			...
			<?php
				...
				$result = mysqli_query($con, "SELECT * FROM pwd_table where pwd_barangay='$barangay' and pwd_number='' ORDER BY pwd_lastname ASC");
				$count = 1;
