    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              <div class="card-header">
                <h1 class="card-title">With PWD ID Number</h1>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="../controller.php?edit-pwd=<?php echo $col['pwd_id']?>&barangay=<?php echo $barangay?>" class="btn btn-primary btn-xs" title="Edit"><span class="fa fa-pen"></span></a>
                          <a href="../controller.php?delete-pwd=<?php echo $col['pwd_id']?>&barangay=<?php echo $barangay?>" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('Are you sure you want to remove <?php echo $col['pwd_firstname']?> <?php echo $col['pwd_lastname']?> record?')"><span class="fa fa-trash"></span></a>
                        </td> 
                      </tr>
                      <?php }?>
                    </tbody>
                      ...
                      <div class="modal-body">
                          ...
                          <div class="row pb-3">
                            ...
                            <div class="form-group col-8">
                              ...
                              <input type="text" class="form-control form-control-border" name="id_number_static" placeholder="ID Number" id="pwd_keyup_value" value="<?php echo $pwd_static ?>" disabled>
              ...
              <div class="card mx-4 shadow-lg">
              <div class="card-header">
                <h1 class="card-title">Without PWD ID Number</h1>
...
<script type="text/javascript">
  $(function(){
    $("#pwd_keyup").keyup(function (){
      ...
      else if (length_input == 3) {
        var zeros = "0000";
      }
      else if (length_input == 4) {
        var zeros = "000";
      }
      else if (length_input == 5) {
        var zeros = "00";
      }
      else if (length_input == 6) {
        var zeros = "0";
      }
      else {
        var zeros = "";
