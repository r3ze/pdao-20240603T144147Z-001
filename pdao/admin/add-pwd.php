    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              ...
              <div class="card-body">
                <div class="container">
                  ...
                  <div class="col-sm-6">
                      <div class="card-box bg-primary py-5">
                          ...
                          <a href="new-pwd.php" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-sm-12">
                      <div class="card-box bg-dark py-5">
                          <div class="inner">
                          ...
                          <a href="recently.php" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
                      </div>
                  </div>
                </div>
                </div>
