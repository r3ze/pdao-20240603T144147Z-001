    ...
    <div class="sidebar pt-5 ">
      ...
      <nav class="mt-5">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="add-pwd.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="add-pwd.php"> Add PWD</a></li>
              ...
              <div class="card-body">
                ...
                <div class="row pb-3">
                  <div class="form-group col-6">
                    ...
                    <textarea class="form-control " name="pwd_accessibility" required><?php echo $_POST['pwd_accessibility'];?></textarea>
                  </div>

                  <div class="form-group col-6">
                    <label>Services Needs (e.g., Medical, Therapy, Education)</label>
                    <textarea class="form-control " name="pwd_services" required><?php echo $_POST['pwd_services'];?></textarea>
                  </div>
