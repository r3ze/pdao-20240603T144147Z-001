    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              <div class="card-header">
                <h1 class="card-title">History Log</h1>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered" id="example">
                          ...
                          <tbody>
                            <?php
                              $result2 = mysqli_query($con, "SELECT * from history_log where account_id NOT IN (SELECT account_id FROM account_table where user_type='admin') ORDER BY date_time DESC");
                            ...
                            <tr>
                              <?php 
                                ...
                                $name_query = mysqli_query($con, "SELECT CONCAT(firstname,' ', lastname) as fullname from account_table where account_id='$account_id'");
                                $fetch = mysqli_fetch_assoc($name_query);
                                $fetch_name = $fetch['fullname'];
                              ?>
                              <td><?php echo $fetch_name; ?></td>
                              <td><?php echo $col['activity']; ?></td>
