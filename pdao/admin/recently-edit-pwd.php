<?php
  ...
  $pwd_number = $_SESSION['pwd_number2'];

  $disability_string = $_SESSION['pwd_disability_type2'];
  $disability_array = explode(',',$disability_string);

  $cause_string = $_SESSION['pwd_disability_cause2'];
  $cause_array = explode(',',$cause_string);
  
  $support = $_SESSION["pwd_support2"];
  $pensioner = $_SESSION["pwd_pensioner2"];
        ...
        <div class="row mb-2">
          ...
          <div class="col-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="add-pwd.php">Add PWD</a></li>
              <li class="breadcrumb-item"><a href="recently.php">PWD Recently Added</a></li>
              ...
              <div class="card-body">
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    ...
                    <input class="form-control" type="date" name="date_applied" value="<?php echo $_SESSION['date_applied2'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Last Name" name="pwd_lastname" value="<?php echo $_SESSION['pwd_lastname2'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="First Name" name="pwd_firstname" value="<?php echo $_SESSION['pwd_firstname2'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Middle Name" name="pwd_middlename" value="<?php echo $_SESSION['pwd_middlename2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Suffix" name="pwd_suffix" value="<?php echo $_SESSION['pwd_suffix2'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    ...
                    <input class="form-control calculate-age" type="date" name="pwd_birthday" value="<?php echo $_SESSION['pwd_birthday2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label> Age</label>
                    <input type="number" class="form-control form-control-border calculated-age" id="exampleInputBorder" min="0" placeholder="(If date of birth is not available)" name="pwd_age" value="<?php echo $_SESSION['pwd_age2'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <label> Place of Birth</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Place of Birth" name="pwd_birthplace" value="<?php echo $_SESSION['pwd_birthplace2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label>5. Sex</label>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Religion" name="pwd_religion" value="<?php echo $_SESSION['pwd_religion2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label>7. Ethnic Group</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Ethnic Group" name="pwd_ethnic" value="<?php echo $_SESSION['pwd_ethnic_group2'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="House No. & Street" name="pwd_street" value="<?php echo $_SESSION['pwd_house_street2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mobile No." name="pwd_mobile" value="<?php echo $_SESSION['pwd_mobile2'];?>" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="11" minlength="11">

                  </div>
                  <div class="form-group col-sm-3">
                    <input type="email" class="form-control form-control-border" id="exampleInputBorder" placeholder="E-mail Address" name="pwd_email" value="<?php echo $_SESSION['pwd_email2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Landline No." name="pwd_landline" value="<?php echo $_SESSION['pwd_landline2'];?>" maxlength="11">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Parent/Guardian Contact No." name="pwd_guardian_contact" value="<?php echo $_SESSION['pwd_guardian_contact2'];?>" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="11" minlength="11">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Organization Affiliated" name="pwd_organization" value="<?php echo $_SESSION['pwd_organization2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Contact Person" name="pwd_organizationPerson" value="<?php echo $_SESSION['pwd_organization_contact2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Office Address" name="pwd_organizationAddress" value="<?php echo $_SESSION['pwd_organization_address2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Tel Nos." name="pwd_organizationTelephone" value="<?php echo $_SESSION['pwd_organization_telephone2'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="SSS NO." name="pwd_sss" value="<?php echo $_SESSION['pwd_sss2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="GSIS NO." name="pwd_gsis" value="<?php echo $_SESSION['pwd_gsis2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Pag-IBIG NO." name="pwd_pagibig" value="<?php echo $_SESSION['pwd_pagibig2'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="PhilHealth NO." name="pwd_philhealth" value="<?php echo $_SESSION['pwd_philhealth2'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's Last Name" name="pwd_fatherLastname" value="<?php echo $_SESSION['pwd_father_lastname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's First Name" name="pwd_fatherFirstname"  value="<?php echo $_SESSION['pwd_father_firstname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's Middle Name" name="pwd_fatherMiddlename"  value="<?php echo $_SESSION['pwd_father_middlename2'];?>">
                  </div>  
                </div>

                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's Last Name" name="pwd_motherLastname" value="<?php echo $_SESSION['pwd_mother_lastname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's First Name" name="pwd_motherFirstname" value="<?php echo $_SESSION['pwd_mother_firstname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's Middle Name" name="pwd_motherMiddlename" value="<?php echo $_SESSION['pwd_mother_middlename2'];?>">
                  </div>  
                </div>

                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's Last Name" name="pwd_guardianLastname" value="<?php echo $_SESSION['pwd_guardian_lastname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's First Name" name="pwd_guardianFirstname" value="<?php echo $_SESSION['pwd_guardian_firstname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's Middle Name" name="pwd_guardianMiddlename" value="<?php echo $_SESSION['pwd_guardian_middlename2'];?>">
                  </div>  
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Last Name" name="accomplish_lastname" value="<?php echo $_SESSION['accomplished_lastname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="First Name" name="accomplish_firstname" value="<?php echo $_SESSION['accomplished_firstname2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Middle Name" name="accomplish_middlename" value="<?php echo $_SESSION['accomplished_middlename2'];?>">
                  </div>  
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Name" name="reportingUnit_name" value="<?php echo $_SESSION['reporting_unit2'];?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <label>21. Registration Number</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Registration Number" name="registration_number" value="<?php echo $_SESSION['registration_number2'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Name of Spouse" name="pwd_spouseName" value="<?php echo $_SESSION['pwd_spouse_name2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Age" min="1" name="pwd_spouseAge" value="<?php if($_SESSION['pwd_spouse_age2'] == 0){ echo ""; } else {echo $_SESSION['pwd_spouse_age2'];}?>">
                  </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Type of Pensioner" name="pwd_pensionerType" value="<?php echo $_SESSION['pwd_pensioner_type2'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" min="1" placeholder="Monthly Pension" name="pwd_pensionMonthly" value="<?php echo $_SESSION['pwd_pension_monthly2'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Source of Income" name="pwd_incomeSource" value="<?php echo $_SESSION['pwd_income_source2'];?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" min="1" placeholder="Estimated Monthly Income" name="pwd_incomeMonthly" value="<?php echo $_SESSION['pwd_income_monthly2'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-6">
                    <label>Remarks</label>
                    <textarea class="form-control " name="pwd_remarks"><?php echo $_SESSION['pwd_remarks2'];?></textarea>
                  </div>
                  <div class="form-group col-6">
                    <label>Interview by</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Interviewed By"  value="<?php echo $_SESSION['interviewed_by2'];?>" disabled>
                    <input type="hidden" name="pwd_interviewer" value="<?php echo $_SESSION['interviewed_by2'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-6">
                    ...
                    <textarea class="form-control " name="pwd_accessibility" required><?php echo $_SESSION['pwd_accessibility'];?></textarea>
                  </div>

                  <div class="form-group col-6">
                    <label>Services Needs (e.g., Medical, Therapy, Education)</label>
                    <textarea class="form-control " name="pwd_services" required><?php echo $_SESSION['pwd_services'];?></textarea>
                  </div>
                ...
                <br><br><br>
                <button type="submit" class="btn btn-primary" name="recently-submit-edit-pwd">Submit</button> &nbsp <input class="btn btn-danger" type="button" value="Reset" onclick="confirm_reset()">
              </div>
              <!-- /.card-body -->
              </form>
...
<script type="text/javascript">
  ...
  // Gender Selection
  var gender = "<?php echo $_SESSION['pwd_sex2'];?>";
  if (gender == "Male") {
  ...
  var civil = "<?php echo $_SESSION['pwd_civil_status2'];?>";
  if (civil == "Single") {
  ...
  // Blood Selection
  var blood = "<?php echo $_SESSION['pwd_blood_type2'];?>";
  if (blood == "A+") {
    $("#select_blood").val("A+");
  }
  else if (blood == "A-") {
...
// Barangay Selection
  var barangay = "<?php echo $_SESSION['pwd_barangay2'];?>";
  if (barangay == "Anibong") {
  ...
  // Education Selection
  var education = "<?php echo $_SESSION['pwd_education2'];?>";
  if (education == "None") {
  ...
  var status = "<?php echo $_SESSION['pwd_employment_status2'];?>";
  if (status == "Employed") {
  ...
  var category = "<?php echo $_SESSION['pwd_employment_category2'];?>";
  ...
  var type = "<?php echo $_SESSION['pwd_employment_type2'];?>";
  ...
  var occupation = "<?php echo $_SESSION['pwd_occupation2'];?>";
  if (occupation == "Managers") {
    ...
    var select = $("#select_occupation");    //caching select, which value was changed
      if(select.val() == "Others"){     //checking if we selected the right option
          $("<input>").attr({type: "text", name: "pwd_occupationOther", class: "form-control form-control-border", id: "other_occupation_id", placeholder:"Other Occupation"}).appendTo(select.parent()).focus();   //creating new input element object, setting its value to "value4" and appending to select parent element or wherever you want it
          $("#other_occupation_id").val("<?php echo $_SESSION['pwd_occupation2'] ?>");
      }
      else if(select.val() != "Others") {
        $('#other_occupation_id').remove();
      }
  ...
  // Gender Selection
  var living = "<?php echo $_SESSION['pwd_living2'];?>";
  ...
  ?>
    ...
    $("#pwd_unique").val("<?php echo $_SESSION['pwd_number2'];?>");
  <?php  
  }
  ?>
