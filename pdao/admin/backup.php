    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              ...
              <div class="card-body text-center">
                <form method="POST">
                <button type="submit" name="backupnow" class="btn btn-lg btn-primary" onclick="return confirm('Are you sure you want to backup your database?');"><i class="fa fa-database"></i> Backup</button><br><br>
                <div class="text-center font-italic">Note: This button is for monthly backup of database.</div>
                </form>
              </div>
              <!-- /.card-body -->
