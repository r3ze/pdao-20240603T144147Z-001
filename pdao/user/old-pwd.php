        ...
        <div class="row mb-2">
          ...
          <div class="col-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Existing PWD</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              <div class="card-header">
                <h1 class="card-title">Existing PWD</h1>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-9">
                    ...
                    <input type="text" class="form-control form-control-border checking-number" id="exampleInputBorder" placeholder="RR-PPMM-BBB-NNNNNNN" name="pwd_number" value="<?php echo $_POST['pwd_number'];?>" required>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Last Name" name="pwd_lastname" value="<?php echo $_POST['pwd_lastname'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="First Name" name="pwd_firstname" value="<?php echo $_POST['pwd_firstname'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    <label> Age</label>
                    <input type="number" class="form-control form-control-border calculated-age" id="exampleInputBorder" min="0" placeholder="(If date of birth is not available)" name="pwd_age" value="<?php echo $_POST['pwd_age'];?>" required>
                  </div>
                  <div class="form-group col-sm-3">
                ...
                <br><br><br>
                <button type="submit" class="btn btn-primary" name="add-existing-pwd">Submit</button> &nbsp <input class="btn btn-danger" type="button" value="Reset" onclick="confirm_reset()">
              </div>
              <!-- /.card-body -->
              </form>
