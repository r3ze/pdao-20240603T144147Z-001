<?php
  ...
  $support_string = $_SESSION["pwd_support"];
  $support_array = explode(',', $support_string);
        ...
        <div class="row mb-2">
          ...
          <div class="col-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="list-pwd.php">PWD Recently Added</a></li>
              ...
              <div class="card-body">
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-9">
                    ...
                    <input type="text" class="form-control form-control-border checking-number" id="pwd_unique" placeholder="RR-PPMM-BBB-NNNNNNN" name="pwd_number" readonly="true">
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Last Name" name="pwd_lastname" value="<?php echo $_SESSION['pwd_lastname'];?>" readonly="true">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="First Name" name="pwd_firstname" value="<?php echo $_SESSION['pwd_firstname'];?>" readonly="true">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Middle Name" name="pwd_middlename" value="<?php echo $_SESSION['pwd_middlename'];?>" readonly="true">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Suffix" name="pwd_suffix" value="<?php echo $_SESSION['pwd_suffix'];?>" readonly="true">
                  </div>
                </div>
