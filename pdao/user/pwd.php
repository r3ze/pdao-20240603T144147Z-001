<?php
  ...
  $disability_array = $_POST['disability_type'];
  $cause_array = $_POST['disability_cause'];
  
  
  $support_array = $_POST["economic_condition"];
        ...
        <div class="row mb-2">
          ...
          <div class="col-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="index.php"> Add PWD</a></li>
              <li class="breadcrumb-item active"> New PWD</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="card mx-4 shadow-lg">
              <div class="card-header">
                <h1 class="card-title">New PWD</h1>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-9">
                    ...
                    <input type="text" class="form-control form-control-border checking-number" id="exampleInputBorder" placeholder="RR-PPMM-BBB-NNNNNNN" name="pwd_number" value="<?php echo $_POST['pwd_number'];?>" disabled>
                    <span class="error-message text-danger"></span>
                  </div>
                  <!-- Date -->
                  <div class="form-group col-sm-3">
                    <label>2. Date Applied</label>
                    <input class="form-control" type="date" name="date_applied" value="<?php echo $_POST['date_applied'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" placeholder="Last Name" name="pwd_lastname" value="<?php echo $_POST['pwd_lastname'];?>" id="pwd_unique_lname" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" placeholder="First Name" name="pwd_firstname" value="<?php echo $_POST['pwd_firstname'];?>" id="pwd_unique_fname" required>
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Middle Name" name="pwd_middlename" value="<?php echo $_POST['pwd_middlename'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Suffix" name="pwd_suffix" value="<?php echo $_POST['pwd_suffix'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    ...
                    <input class="form-control calculate-age" type="date" name="pwd_birthday" value="<?php echo $_POST['pwd_birthday'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label> Age</label>
                    <input type="number" class="form-control form-control-border calculated-age" id="exampleInputBorder" min="0" placeholder="(If date of birth is not available)" name="pwd_age" value="<?php echo $_POST['pwd_age'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label> Place of Birth</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Place of Birth" name="pwd_birthplace" value="<?php echo $_POST['pwd_birthplace'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label>5. Sex</label>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Religion" name="pwd_religion" value="<?php echo $_POST['pwd_religion'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <label>7. Ethnic Group</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Ethnic Group" name="pwd_ethnic" value="<?php echo $_POST['pwd_ethnic'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-8">
                    ...
                    <div class="row">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="disability_type[]" value="Cancer" id="disability_10">
                        <label class="form-check-label">Cancer (RA11215)</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="disability_type[]" value="Rare Disease" id="disability_11">
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="House No. & Street" name="pwd_street" value="<?php echo $_POST['pwd_street'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-3">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mobile No." name="pwd_mobile" value="<?php echo $_POST['pwd_mobile'];?>" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="11" minlength="11">

                  </div>
                  <div class="form-group col-sm-3">
                    <input type="email" class="form-control form-control-border" id="exampleInputBorder" placeholder="E-mail Address" name="pwd_email" value="<?php echo $_POST['pwd_email'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Landline No." name="pwd_landline" value="<?php echo $_POST['pwd_landline'];?>" maxlength="11">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Parent/Guardian Contact No." name="pwd_guardian_contact" value="<?php echo $_POST['pwd_guardian_contact'];?>" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="11" minlength="11">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Organization Affiliated" name="pwd_organization" value="<?php echo $_POST['pwd_organization'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Contact Person" name="pwd_organizationPerson" value="<?php echo $_POST['pwd_organizationPerson'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Office Address" name="pwd_organizationAddress" value="<?php echo $_POST['pwd_organizationAddress'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Tel Nos." name="pwd_organizationTelephone" value="<?php echo $_POST['pwd_organizationTelephone'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="SSS NO." name="pwd_sss" value="<?php echo $_POST['pwd_sss'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="GSIS NO." name="pwd_gsis" value="<?php echo $_POST['pwd_gsis'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Pag-IBIG NO." name="pwd_pagibig" value="<?php echo $_POST['pwd_pagibig'];?>">
                  </div>
                  <div class="form-group col-sm-3">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="PhilHealth NO." name="pwd_philhealth" value="<?php echo $_POST['pwd_philhealth'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's Last Name" name="pwd_fatherLastname" value="<?php echo $_POST['pwd_fatherLastname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's First Name" name="pwd_fatherFirstname"  value="<?php echo $_POST['pwd_fatherFirstname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Father's Middle Name" name="pwd_fatherMiddlename"  value="<?php echo $_POST['pwd_fatherMiddlename'];?>">
                  </div>  
                </div>

                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's Last Name" name="pwd_motherLastname" value="<?php echo $_POST['pwd_motherLastname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's First Name" name="pwd_motherFirstname" value="<?php echo $_POST['pwd_motherFirstname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Mother's Middle Name" name="pwd_motherMiddlename" value="<?php echo $_POST['pwd_motherMiddlename'];?>">
                  </div>  
                </div>

                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's Last Name" name="pwd_guardianLastname" value="<?php echo $_POST['pwd_guardianLastname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's First Name" name="pwd_guardianFirstname" value="<?php echo $_POST['pwd_guardianFirstname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Guardian's Middle Name" name="pwd_guardianMiddlename" value="<?php echo $_POST['pwd_guardianMiddlename'];?>">
                  </div>  
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Last Name" name="accomplish_lastname" value="<?php echo $_POST['accomplish_lastname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="First Name" name="accomplish_firstname" value="<?php echo $_POST['accomplish_firstname'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Middle Name" name="accomplish_middlename" value="<?php echo $_POST['accomplish_middlename'];?>">
                  </div>  
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Name" name="reportingUnit_name" value="<?php echo $_POST['reportingUnit_name'];?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <label>21. Registration Number</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Registration Number" name="registration_number" value="<?php echo $_POST['registration_number'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  ...
                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Name of Spouse" name="pwd_spouseName" value="<?php echo $_POST['pwd_spouseName'];?>">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" placeholder="Age" min="1" name="pwd_spouseAge" value="<?php echo $_POST['pwd_spouseAge'];?>">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-4">
                    <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="economic_condition[]" value="Receiving Support from relatives/friends" id="economic_1">
                    <label class="form-check-label">Receiving Support from relatives/friends</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="economic_condition[]" value="Pensioner" id="economic_2">
                    <label class="form-check-label">Pensioner</label>
                  </div>
                  </div>

                  <div class="form-group col-sm-4">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Type of Pensioner" name="pwd_pensionerType">
                  </div>
                  <div class="form-group col-sm-4">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" min="1" placeholder="Monthly Pension" name="pwd_pensionMonthly">
                  </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-sm-6">
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Source of Income" name="pwd_incomeSource" value="<?php echo $_POST['pwd_incomeSource'];?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <input type="number" class="form-control form-control-border" id="exampleInputBorder" min="1" placeholder="Estimated Monthly Income" name="pwd_incomeMonthly" value="<?php echo $_POST['pwd_incomeMonthly'];?>">
                  </div>
                </div>
                ...
                <div class="row pb-3">
                  <div class="form-group col-6">
                    <label>Remarks</label>
                    <textarea class="form-control " name="pwd_remarks"><?php echo $_POST['pwd_remarks'];?></textarea>
                  </div>
                  <div class="form-group col-6">
                    <label>Interview by</label>
                    <input type="text" class="form-control form-control-border" id="exampleInputBorder" placeholder="Interviewed By"  value="<?php echo $_SESSION['username']; ?>" disabled>
                    <input type="hidden" name="pwd_interviewer" value="<?php echo $_SESSION['username']; ?>">
                  </div>
                ...
                <br><br><br>
                <button type="submit" class="btn btn-primary" name="add-pwd">Submit</button> &nbsp <input class="btn btn-danger" type="button" value="Reset" onclick="confirm_reset()">
              </div>
              <!-- /.card-body -->
              </form>
...
<script type="text/javascript">
  ...
  var civil = "<?php echo $_POST['pwd_civilStatus'];?>";
  if (civil == "Single") {
  ...
  // Blood Selection
  var blood = "<?php echo $_POST['pwd_bloodType'];?>";
  if (blood == "A+") {
    $("#select_blood").val("A+");
  }
  else if (blood == "A-") {
  ...
  <?php
    ...
    else if ($cause_string == "Rare Disease") {
    ?>
  ...
  ?>
// Barangay Selection
  var barangay = "<?php echo $_POST['pwd_barangay'];?>";
  if (barangay == "Anibong") {
  ...
  // Education Selection
  var education = "<?php echo $_POST['pwd_education'];?>";
  if (education == "None") {
  ...
  var status = "<?php echo $_POST['pwd_employmentStatus'];?>";
  if (status == "Employed") {
  ...
  var category = "<?php echo $_POST['pwd_employmentCategory'];?>";
  ...
  var type = "<?php echo $_POST['pwd_employmentType'];?>";
  ...
  var occupation = "<?php echo $_POST['pwd_occupation'];?>";
  if (occupation == "Managers") {
    ...
    var select = $("#select_occupation");    //caching select, which value was changed
      if(select.val() == "Others"){     //checking if we selected the right option
          $("<input>").attr({type: "text", name: "pwd_occupationOther", class: "form-control form-control-border", id: "other_occupation_id", placeholder:"Other Occupation"}).appendTo(select.parent());   //creating new input element object, setting its value to "value4" and appending to select parent element or wherever you want it
          $("#other_occupation_id").val("<?php echo $_POST['pwd_occupationOther'] ?>");
      }
      else if(select.val() != "Others") {
        $('#other_occupation_id').remove();
      }
  ...
  // Gender Selection
  var living = "<?php echo $_POST['living'];?>";
  ...
  <?php
  foreach($support_array as $support_string){
    if ($support_string == "Receiving Support from relatives/friends") {
      ?>
      $("#economic_1").prop( "checked", true );
      <?php
    }
    elseif($support_string == "Pensioner"){
      ?>
  ...
  $('#pwd_unique_name').keyup(function(e){
        // alert("Hellow");
        var pwd_firstname = $(this).val();
        var pwd_lastname = $('#pwd_unique_lname').val();
        // alert(pwd_number);
        $.ajax({
          type: "POST",
          url: "../controller.php",
